...
const mockDate: Date = vi.hoisted(() => new Date(2024, 4, 21, 0, 0, 0));
...
describe(`Pilot banner`, () => {
  test(`matches snapshot post filing deadline`, async () => {
    expect(mockDate.toLocaleString(`default`, { month: `long` })).toBe(`May`);
