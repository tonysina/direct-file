...
describe(`Deductions page`, () => {
  test(`matches snapshot`, () => {
    const { asFragment } = render(wrapComponent(<Deductions />, { route: `/deductions` }));
      ...
      <DocumentFragment>
        ...
        >
          ...
          >
            ...
            >
              pages.ScreenerDeductions.heading
            </h2>
          </div>
          <div
            class="margin-top-3"
          ...
          >
            ...
            >
              ...
              >
                <button
                  aria-controls="pages.ScreenerDeductions.StandardDeduction"
                  aria-expanded="false"
                  class="usa-accordion__button"
                  data-testid="accordionButton_pages.ScreenerDeductions.StandardDeduction"
                  type="button"
                />
              </h3>
              <div
                class="usa-accordion__content usa-prose"
                data-testid="accordionItem_pages.ScreenerDeductions.StandardDeduction"
                hidden=""
                id="pages.ScreenerDeductions.StandardDeduction"
              />
            </div>
          </div>
          <div
          ...
          >
            ...
            >
              ...
              >
                <button
                  aria-controls="pages.ScreenerDeductions.ItemizedDeductions"
                  aria-expanded="false"
                  class="usa-accordion__button"
                  data-testid="accordionButton_pages.ScreenerDeductions.ItemizedDeductions"
                  type="button"
                />
              </h3>
              <div
                class="usa-accordion__content usa-prose"
                data-testid="accordionItem_pages.ScreenerDeductions.ItemizedDeductions"
                hidden=""
                id="pages.ScreenerDeductions.ItemizedDeductions"
              />
            </div>
          </div>
        </div>
        ...
        >
          <a
            ...
            href="/credits"
          >
            pages.ScreenerDeductions.button.text
          </a>
        </div>
      </DocumentFragment>
    `);
