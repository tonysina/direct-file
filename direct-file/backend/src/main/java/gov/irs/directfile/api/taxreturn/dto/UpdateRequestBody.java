            ...
            """
      {
         "facts": {
          ...
          "/email": {
            ...
            "item": { "email": "test.user.2@direct-file.local" }
          },
          ...
          "/filerResidenceAndIncomeState": {
            "$type": "gov.irs.factgraph.persisters.EnumWrapper",
            "item": { "value": ["ma"], "enumOptionsPath": "/scopedStateOptions" }
          },
