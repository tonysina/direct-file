  ...
  describe("MaxLength") {
    describe("can work with strings") {
      ...
      it("and allow a save if it there is a warning level violation") {
        ...
        assert(saved._2.head.actual == "3")
        assert(saved._2.head.limit == "1")
        assert(saved._2.head.limitName == "MaxLength")
