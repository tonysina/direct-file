...
/**
 * @deprecated V1 messages are no longer sent, but keeping payload until we are sure queues are V1-free
 */
@Deprecated
@Getter
public class SubmissionConfirmationPayloadV1 extends AbstractSubmissionConfirmationPayload {
    private final List<TaxReturnSubmissionReceipt> receipts;
    ...
    public SubmissionConfirmationPayloadV1(@JsonProperty("receipts") List<TaxReturnSubmissionReceipt> receipts) {
