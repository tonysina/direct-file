...
@Getter
@Slf4j
public class SubmissionConfirmationPayloadV2 extends AbstractSubmissionConfirmationPayload {
    private final List<SubmissionConfirmationPayloadV2Entry> entries;
    ...
    public SubmissionConfirmationPayloadV2(
            @JsonProperty("entries") List<SubmissionConfirmationPayloadV2Entry> entries) {
